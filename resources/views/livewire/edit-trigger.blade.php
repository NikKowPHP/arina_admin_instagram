...
<div class="container mx-auto py-8">
    <h1 class="text-2xl font-bold mb-4">Edit Trigger</h1>
    ...
    <form wire:submit.prevent="updateForm" class="max-w-md mx-auto">
        <div>
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Update Trigger</button>
    </form>
</div>
@endsection
